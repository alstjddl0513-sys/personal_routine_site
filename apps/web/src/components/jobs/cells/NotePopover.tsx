  ...
  return (
    <>
      <button
        ...
        onClick={() => setOpen((v) => !v)}
        disabled={isPending}
        className="inline-flex max-w-[10rem] items-center gap-1 rounded px-1.5 py-0.5 text-xs text-zinc-600 hover:bg-zinc-100 disabled:opacity-50 dark:text-zinc-400 dark:hover:bg-zinc-800"
